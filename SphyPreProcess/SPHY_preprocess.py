...
class SphyPreProcess:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&SPHY preprocessor')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'SphyPreProcess')
        self.toolbar.setObjectName(u'SphyPreProcess')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('SphyPreProcess', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/SphyPreProcess/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'SPHY preprocessor'),
            callback=self.run,
